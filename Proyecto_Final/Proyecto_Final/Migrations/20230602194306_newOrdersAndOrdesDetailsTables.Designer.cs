...
namespace Proyecto_Final.Migrations
{
    ...
    [Migration("20230602194306_newOrdersAndOrdesDetailsTables")]
    partial class newOrdersAndOrdesDetailsTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Proyecto_Final.DAL.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Proyecto_Final.DAL.Entities.OrderDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Proyecto_Final.DAL.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Proyecto_Final.DAL.Entities.ProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Proyecto_Final.DAL.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Proyecto_Final.DAL.Entities.City", b =>
                {
                    b.HasOne("Proyecto_Final.DAL.Entities.State", "State")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("Proyecto_Final.DAL.Entities.OrderDetail", b =>
                {
                    b.HasOne("Proyecto_Final.DAL.Entities.Order", "Order")
                    ...
                    b.HasOne("Proyecto_Final.DAL.Entities.TemporalSale", "TemporalSale")
                        .WithMany("OrderDetails")
